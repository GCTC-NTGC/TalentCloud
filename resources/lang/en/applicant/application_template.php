...
return [
    ...
    */
    ...
    'application_success' => 'You\'ve successfully applied to:',
    ...
    'complete' => [
        ...
        'next_step_copy_1' => 'While you\'re waiting to hear about your application, there are a couple of things you can proactively do to help speed up the process. The position you just applied to requires a',
        'next_step_copy_2' => 'security clearance. To help speed up the process,',
        'next_step_copy_faq_link_title' => 'Learn more about obtaining security clearance.',
        'next_step_copy_faq_link_label' => 'find out more about the process to obtain this security clearance on our FAQ',
        'reminder' => 'Reminder:',
        'reminder_copy' => 'this position will continue to accept other applications until',
        'view_application_title' => 'View your submitted application.',
        'view_application_label' => 'View your submitted application',
        'other_resources' => 'Other Resources',
        'submit_feedback_link_title' => 'Submit feedback about Talent Cloud via email.',
        'submit_feedback_link_label' => 'Submit feedback on your experience',
        'update_profile_link_title' => 'Open your profile.',
        'update_profile_link_label' => 'Update your profile',
        'browse_jobs_title' => 'Browse other jobs.',
        'browse_jobs_label' => 'Browse other jobs',
        'faq_link_title' => 'Learn more about the hiring process.',
        'faq_link_label' => 'Learn about the hiring process',
