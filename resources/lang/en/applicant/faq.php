        ...
        "sections" => [
            "00" => [
                "copy" => [
                    ...
                    "05" => "If the job you’ve applied to requires Reliability Level security, complete the form found here and then hold onto it. Once complete, don’t email it to Talent Cloud until you get asked for it.",
                    "06" => "If the job you’ve applied to requires Secret Level security, you’ll need to complete both a Reliability Clearance form and a Secret Clearance form. Once these two forms are complete, don’t email them to Talent Cloud until you get asked for them.",
