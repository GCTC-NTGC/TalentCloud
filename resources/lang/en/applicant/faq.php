    ...
    "know" => [
        ...
        "sections" => [
            ...
            "02" => [
                ...
                "copy" => [
                    "00" => "All jobs posted on Talent Cloud during the pilot are term positions. That means you are a Government of Canada employee for the duration of your contract. You can start to accrue benefits after 3 months and pension after 6 months of continuous term employment. It's possible to take sequential terms, lining them up for continuous employment with the Government of Canada, while taking on different projects in different departments if you choose. Term positions can be extended up to 3 years. After 3 years in the same position, term employees become indeterminate (permanent) employees, except in exceptional circumstances.",
                    "01" => "Talent Cloud started with jobs related to digital, tech, and UX. Think positions like \"data scientist\", \"programmer\", \"tech project manager\", and \"user experience designer\".",
                    "02" => "Since then, we've launched staffing streams in administrative positions and HR. Next we'll be expanding to include policy, project management, and procurement positions, which we expect to post later on this spring."
                ]
            ],
            "03" => [
            ...
            "05" => [
                ...
                "copy" => [
                    "00" => "Talent Cloud is working toward a 30-day hiring experience from job advertisement to letter of offer. We're currently piloting the project so, right now, applicants should expect to hear back about their initial application within 2-weeks of the job advertisement closing. For those who move past the initial screening in a position that has been advertised as bilingual, expect language testing early in the process. (If you have never taken any language testing with the Government of Canada before, you may want to try these <a href=\"https://www.canada.ca/en/public-service-commission/services/second-language-testing-public-service/self-assessment-tests.html\" target=\"__blank\" rel=\"noopener noreferrer\" title=\"Take the tests\">self-assessment tests</a> to get a sense of what the tests are like).",
        ...
        "sections" => [
            "00" => [
                "copy" => [
                    ...
                    "05" => "If the job you've applied to requires Reliability Level security, complete the <a href=\"http://www.tbs-sct.gc.ca/tbsf-fsct/330-23-eng.asp\" target=\"__blank\" rel=\"noopener noreferrer\" title=\"Open the form in a new tab or window.\">form found here</a> and then hold onto it. Once complete, don't email it to Talent Cloud until you get asked for it.",
                    "06" => "If the job you've applied to requires Secret Level security, you'll need to complete both a <a href=\"http://www.tbs-sct.gc.ca/tbsf-fsct/330-23-eng.asp\" target=\"__blank\" rel=\"noopener noreferrer\" title=\"Open the form in a new tab or window.\">Reliability Clearance form</a> and a <a href=\"http://www.tbs-sct.gc.ca/tbsf-fsct/330-60-eng.asp\" target=\"__blank\" rel=\"noopener noreferrer\" title=\"Open the form in a new tab or window.\">Secret Clearance form</a>. Once these two forms are complete, don't email them to Talent Cloud until you get asked for them.",
