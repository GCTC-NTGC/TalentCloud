    ...
    "know" => [
        ...
        "sections" => [
            ...
            "05" => [
                ...
                "copy" => [
                    "00" => "Eventually, Talent Cloud is hoping to be able to offer a 30 day hiring experience (from job advertisement to letter of offer). For the initial experiment, applicants should expect to hear back about their initial application within 2 weeks of the job advertisement closing. For those moving on to further rounds of screening in a position that has been advertised as bilingual, expect language testing early in the process. (If you have never taken any language testing with the Government of Canada before, you may want to try these <a href=\"https://www.canada.ca/en/public-service-commission/services/second-language-testing-public-service/self-assessment-tests.html\" target=\"__blank\" rel=\"noopener noreferrer\" title=\"Take the tests.\">self-assessment tests</a> to get a sense of what the tests are like.)",
