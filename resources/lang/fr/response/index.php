    ...
    */
    ...
    'content' => [
        ...
        'github_url' => [
            ...
            'title' => 'Visitez le Nuage de talents sur Github pour plus d’information.'
        ],
        'email' => [
            'or' => 'ou',
        ...
        'submit_name' => [
            'text' => 'Comment soumettre votre nom',
            'title' => 'Pour en connaître davantage sur la façon dont vous pouvez aider en cas d’urgence.',
        ],
        'get_approval' => [
            'text' => 'Comment obtenir l’approbation de participer',
            'title' => "Découvrez si vous êtes en mesure d’offrir vos compétences.",
        ],
        'need_help' => [
    ...
    'job_list' => [
        'title' => 'Le gouvernement du Canada cherche de l’aide supplémentaire dans ces domaines :',
    ...
    'how' => [
        'title' => 'Comment soumettre votre nom',
        'canadians_helping' => 'Les Canadiens sont connus pour prendre soin les uns des autres, même lorsque les temps sont durs. Félicitations pour avoir offert vos compétences au gouvernement du Canada afin de pouvoir aider les Canadiens là où ils en ont le plus besoin!',
        'button_list' => [
            1 => 'Étape 01 : Présenter une demande',
            2 => 'Étape 02 : Prochaines étapes',
            3 => 'Étape 03 : Placement de la réserve',
            4 => 'Étape 04 : Pour démarrer',
        ],
        'list_content' => [
            1 => [
            ...
            2 => [
                ...
                'body' => 'Oui, vous aurez des nouvelles de l’équipe. Et rapidement si vous avez les compétences requises. Vous pouvez vous attendre à recevoir un courriel où l’on vous posera quelques brèves questions supplémentaires, comme le nom d’un répondant que nous pouvons contacter. Ce processus prend environ 10 minutes.'
            ],
            3 => [
                'title' => 'Étape 03 : Pour être placé dans une réserve appelée « Prêt à affecter »',
                'body' => 'Une fois votre vérification des références terminée, vous serez placé sur une liste de personnes prêtes à être envoyées aux ministères qui a des besoins essentiels dans les domaines pour lesquels vous avez présenté une demande. Vous pouvez être appelé immédiatement ou ne pas être appelé du tout. Nous vous informerons également lorsque vous n’aurez plus besoin d’être dans la réserve pour pas que vous restiez dans le flou. Pendant que vous êtes dans cette réserve, assurez-vous <a href="mailto:Talent.Cloud-nuage.de.talents@tbs-sct.gc.ca" title="Envoyer un courriel au Nuage de talents." target="_blank">envoyez-nous un courriel</a> si vous devez retirer votre nom pour une raison quelconque. Nous voulons être sûrs de seulement envoyer les noms des personnes actuellement disponibles aux ministères dans le besoin.',
            ],
            4 => [
                'title' => 'Étape 04 : Pour être envoyé à un ministère!',
                'body' => 'Une fois que vous êtes apparié avec un ministère qui a besoin de votre aide, le ministère communiquera avec vous pour vous donner de l’information sur cette occasion. Si ce n’est vraiment pas pour vous, vous pouvez retirer votre nom de la liste de la réserve dès lors. Cependant, on s’attend à ce que vous finissiez par aider une nouvelle équipe pendant un certain temps. Cette occasion constituera un arrangement à niveau et peut être de nature informelle. Votre ministère d’attache et votre ministère hôte se coordonneront pour rendre cela possible. Si vous y allez, écrivez-nous et dites-nous comment cela s’est passé. Nous recueillons les témoignages des utilisateurs et nous souhaitons connaître comment améliorer le processus pour la prochaine fois.'
            ],
        ],
    ],
    ...
    'stream' => [
        ...
        'view_job_title' => "Consultez l'offre d'emploi.",
    ],

    'canadian_maple_leaf_alt' => "La feuille d'érable canadienne.",
    'canadian_maple_leaf_icon' => 'Une icône du drapeau canadien.'
];
