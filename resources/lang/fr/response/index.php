    ...
    'how' => [
        ...
        'list_content' => [
            ...
            3 => [
                ...
                'body' => 'Une fois votre vérification des références terminée, vous serez placé sur une liste de personnes prêtes à être envoyées aux ministères qui a des besoins essentiels dans les domaines pour lesquels vous avez présenté une demande. Vous pouvez être appelé immédiatement ou ne pas être appelé du tout. Nous vous informerons également lorsque vous n’aurez plus besoin d’être dans la réserve pour pas que vous restiez dans le flou. Pendant que vous êtes dans cette réserve, assurez-vous <a href="mailto::talentcloud-nuagedetalents@tbs-sct.gc.ca" title="Envoyer un courriel au Nuage de talents." target="_blank">envoyez-nous un courriel</a> si vous devez retirer votre nom pour une raison quelconque. Nous voulons être sûrs de seulement envoyer les noms des personnes actuellement disponibles aux ministères dans le besoin.',
            ],
            4 => [
