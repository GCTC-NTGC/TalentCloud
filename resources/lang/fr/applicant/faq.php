    ...
    "know" => [
        ...
        "sections" => [
            ...
            "02" => [
                ...
                "copy" => [
                    "00" => "Tous les emplois publiés dans le Nuage de talents pendant le projet-pilote sont des postes pour une période déterminée. Cela signifie que vous êtes un(e) employé(e) du gouvernement du Canada pour la durée de votre contrat et que vous pouvez commencer à accumuler des prestations après trois mois et une pension après six mois d'emploi continu. Il est possible de prendre des mandats séquentiels et de les jumeler à un emploi continu au sein du gouvernement du Canada, tout en entreprenant différents projets dans différents ministères, si vous le souhaitez. Les postes à durée déterminée peuvent être prolongés jusqu'à trois ans. Après trois ans au même poste, les employés nommés pour une période déterminée deviennent des employés nommés pour une période indéterminée (permanente), sauf dans des circonstances exceptionnelles.",
                    "01" => "Le Nuage de talents a commencé par offrir des emplois liés au numérique, à la technologie, et à l'expérience de l'utilisateur. Pensez à des postes comme « scientifique des données », « programmeur », « gestionnaire de projet technique », et « concepteur de l'expérience utilisateur ».",
                    "02" => "Depuis lors, nous avons lancé des volets de dotation dans les postes administratifs et les ressources humaines (RH). Ensuite, nous élargirons notre champ d'action pour y inclure les postes en matière de politiques, de gestion de projets et d'approvisionnement, que nous prévoyons publier plus tard ce printemps."
                ]
            ],
            "03" => [
            ...
            "06" => [
                "title" => "Comment décider si je dois postuler ou non?",
                "copy" => [
