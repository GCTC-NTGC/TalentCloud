...
return [
    ...
    'incorrect_code' => 'Mauvais code. Essayer de nouveau.',
    'otp_link_title' => 'Mot de passe à usage unique ',
    'otp_link' => 'Ouvrir une session avec un mot de passe à usage unique.'
];
