...
export const fakeExperienceWork = (
  ...
  is_active: false,
  start_date: dayjs("01/07/2015 09:00:00").utc().toDate(),
  end_date: dayjs("12/13/2019 09:00:00").utc().toDate(),
  experienceable_id: 1,
...
export const fakeExperienceEducation = (
  ...
  is_active: false,
  start_date: dayjs("09/01/2010 09:00:00").utc().toDate(),
  end_date: dayjs("04/30/2015 09:00:00").utc().toDate(),
...
export const fakeExperienceCommunity = (
  ...
  is_active: true,
  start_date: dayjs("04/01/2018 09:00:00").utc().toDate(),
  end_date: null,
  experienceable_id: 1,
  experienceable_type: "applicant",
  is_education_requirement: false,
...
export const fakeExperienceAward = (
  ...
  awarded_date: dayjs("01/27/2016 09:00:00").utc().toDate(),
  experienceable_id: 1,
  experienceable_type: "applicant",
  is_education_requirement: false,
...
export const fakeExperiencePersonal = (
  ...
  is_shareable: true,
  is_active: true,
  start_date: dayjs("04/01/2013 09:00:00").utc().toDate(),
  end_date: null,
  experienceable_id: 1,
  experienceable_type: "applicant",
  is_education_requirement: false,
