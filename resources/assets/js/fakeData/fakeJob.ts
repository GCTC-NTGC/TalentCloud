...
export const fakeJob = (id = 1): Job => ({
  ...
  chosen_lang: "en",
  term_qty: 12,
  open_date_time: new Date("2019-05-20T07:00:00Z"),
  close_date_time: new Date("2019-05-30T06:59:59Z"),
  start_date_time: new Date("2019-07-01T07:00:00Z"),
  created_at: new Date("2019-04-20T07:00:00Z"),
...
export const fakeJob2 = (id = 1): Job => ({
  ...
  chosen_lang: "fr",
  term_qty: 18,
  open_date_time: new Date("2019-05-01T07:00:00Z"),
  close_date_time: new Date("2019-05-15T06:59:59Z"),
  start_date_time: new Date("2019-08-01T07:00:00Z"),
  created_at: new Date("2019-04-25T07:00:00Z"),
  department_id: 2,
