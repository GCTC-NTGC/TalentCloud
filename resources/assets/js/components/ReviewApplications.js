...
const ApplicationReview = props => {
    return (
        <p>
            There is an applicant named {props.application.applicant.user.name}
        </p>
    );
};
        ...
        <section className="applicant-review container--layout-xl">
            <div className="flex-grid gutter">
                <div className="box med-1of2 job-title-wrapper">
                    <span>
                        Viewing Applicants for: {/* Job Title */} (
            ...
            */}
            ...
            <div className="applicant-category">
                <h3 className="heading--03">
                    <i className="fas fa-ban" /> {/* Category Title */}
                </h3>
                ...
                <div className="accordion applicant-bucket">
                    ...
                    >
                        <span className="bucket-title">
                            <i className="fas fa-ban" /> Step {/* Number  */}:{" "}
                            {/* Bucket Title */} (
                            {/* Real-time Number of Applicants */})
                        </span>
