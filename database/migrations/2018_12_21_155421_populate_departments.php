    ...
    */
    public function up()
    {
        DB::table('departments')->insert([
            ...
            ['id' => 7, 'name' => 'border_services_agency'],
            ['id' => 8, 'name' => 'fisheries_and_oceans'],
            ['id' => 9, 'name' => 'innovation_science'],
            ['id' => 10, 'name' => 'public_service_and_procurement'],
        ]);
        ...
        DB::table('department_translations')->insert([
            ...
            ['id' => 13, 'department_id' => 7, 'locale' => 'en', 'value' => 'Canada Border Services Agency'],
            ['id' => 14, 'department_id' => 7, 'locale' => 'fr', 'value' => 'Agence des services frontaliers du Canada'],
            ['id' => 15, 'department_id' => 8, 'locale' => 'en', 'value' => 'Fisheries and Oceans Canada'],
            ['id' => 16, 'department_id' => 8, 'locale' => 'fr', 'value' => 'Pêches et Océans Canada'],
            ['id' => 17, 'department_id' => 9, 'locale' => 'en', 'value' => 'Innovation, Science and Economic Development Canada'],
            ['id' => 18, 'department_id' => 9, 'locale' => 'fr', 'value' => 'Innovation, Sciences et Développement économique Canada'],
            ['id' => 19, 'department_id' => 10, 'locale' => 'en', 'value' => 'Public Services and Procurement Canada'],
            ['id' => 20, 'department_id' => 10, 'locale' => 'fr', 'value' => 'Services publics et Approvisionnement Canada'],
        ]);
    }
