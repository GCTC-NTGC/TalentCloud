    ...
    */
        ...
        foreach ($newCriteriaArray as $criteria) {
            $this->assertDatabaseHas(
                ...
                [
                    ...
                    'description->en' => $criteria['description']['en'],
                    'description->fr' => $criteria['description']['fr'],
                    'specificity->en' => $criteria['specificity']['en'],
                    'specificity->fr' => $criteria['specificity']['fr']
                ]
            );
        }
    }
    ...
    public function testBatchUpdateRemovesCriteria()
    {
        ...
        $this->assertDatabaseHas(
            ...
            [
                ...
                'description->en' => $newData['description']['en'],
                'description->fr' => $newData['description']['fr'],
                'specificity->en' => $newData['specificity']['en'],
                'specificity->fr' => $newData['specificity']['fr']
            ]
        );
    ...
    public function testBatchUpdateUpdatesCriteria()
    {
        ...
        $newData = [
            ...
            'criteria_type_id' => 1,
            'description' => [
                'en' => 'This is the new description',
                'fr' => 'With extra specificity (actually a French translation)'
            ],
            'specificity' => [
                'en' => null,
                'fr' => null
    ...
    public function testBatchUpdateAddsCriteriaWithEmptyOrStringIds()
    {
        ...
        $criteria0 = [
            ...
            'description' => [
                'en' => 'Description 0',
                'fr' => 'Specificity 0 (actually a French translation)'
            ],
            'specificity' => [
                'en' => null,
                'fr' => null
        ...
        $criteria1 = [
            ...
            'description' => [
                'en' => 'Description 1',
                'fr' => 'Specificity 1 (actually a French translation)'
            ],
            'specificity' => [
                'en' => null,
                'fr' => null
    ...
    public function testBatchUpdateCreatesNotifications()
    {
        ...
        $updatedData1 = [
            'id' => $criteria1->id,
            'job_poster_id' => $job->id,
            'skill_id' => 10, // This is definitely different
            'skill_level_id' => 2,
            'criteria_type_id' => 1,
            'description->en' => 'This is the new description',
            'description->fr' => 'With extra specificity (actually a French translation)',
            'specificity->en' => null,
            'specificity->fr' => null
        ];
        // criteria2 will be omitted from the batch update and be deleted
        ...
        $updatedData3 = [
            ...
            'criteria_type_id' => 1,
            'description->en' => 'Only the description of this criteria is changing',
            'description->fr' => 'Okay the specificity is changing too (actually a French translation)',
            'specificity->en' => null,
            'specificity->fr' => null
        ];
        ...
        $newData = [
            ...
            'skill_level_id' => 2,
            'criteria_type_id' => 1,
            'description->en' => 'This one is new',
            'description->fr' => 'Super new (actually a French translation)',
            'specificity->en' => null,
            'specificity->fr' => null
        ];
        ...
        $notificationValues1 = [
            ...
            'criteria_type_id_new' => $updatedData1['criteria_type_id'],
