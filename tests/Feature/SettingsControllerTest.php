...
class SettingsControllerTest extends TestCase
{
    ...
    public function testUpdatePersonalInfoWithValidData(): void
    {
        ...
        $response->assertSee(Lang::get(e('success.update_personal')));
        // Data was updated.
    ...
    public function testPersonalInfoNotValidWhenNameIsEmpty(): void
    {
        ...
        $response->assertSee(Lang::get(e('forms.alert')));
    ...
    public function testUpdateContactPreferencesWithValidData(): void
    {
        ...
        $response->assertOk();
        // Success notification visible.
        $response->assertSee(Lang::get(e('success.update_contact_preferences')));
        // Data was updated.
        $this->assertDatabaseHas('users', $data);
    }
    ...
    public function testUpdatePasswordWithValidData(): void
    {
        ...
        $response->assertOk();
        // Success notification visible.
        $response->assertSee(Lang::get(e('success.update_password')));
    ...
    public function testUpdateGovernmentInfoWithValidData(): void
    {
        ...
        $response->assertOk();
        // Success notification visible.
        $response->assertSee(Lang::get(e('success.update_government')));
    ...
    public function testSoftDeleteApplicant(): void
    {
        ...
        $response->assertOk();
        // Success notification visible.
        $response->assertSee(Lang::get(e('success.delete_account')));
        // Data was scrambled.
