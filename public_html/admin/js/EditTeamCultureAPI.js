...
EditTeamCultureAPI.TeamCulture = function(teamSize, gcDirUrl, narrativeText) {
...
EditTeamCultureAPI.populateTeamCultureForm = function(teamCulture) {
    ...
    document.getElementById('createEditProfile_teamNarrative').value = teamCulture.narrative_text;
};
...
EditTeamCultureAPI.submitTeamCulture = function(managerProfileId) {
    ...
    teamCulture.narrative_text = document.getElementById('createEditProfile_teamNarrative').value;
