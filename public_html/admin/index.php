                                                        ...
                                                        <div style='display:inline-block;'>
                                                            <div class="toggle-btn-group clearfix">
                                                                <div id='createEditProfile_remoteWork' style="position:absolute;top:0px;left:0px;width:6em;height:2em;z-index:100">
                                                                    <input type="radio" id="remoteWork_option0" name="createEditProfile_remoteWork" value="Yes" class="accessAid" checked="checked" onfocus="SliderAPI.toggle('remoteWork', 0)" />
                                                                    <label for="remoteWork_option0" class='option0Label'>Yes</label>
                                                                    <input type="radio" id="remoteWork_option1" name="createEditProfile_remoteWork" value="No" class="accessAid" onfocus="SliderAPI.toggle('remoteWork',1)"/>
                                                        ...
                                                        <div style='display:inline-block;width:48%'>
                                                            <div class="multi-btn-group clearfix">
                                                                <div id='createEditProfile_telework' style="position:absolute;top:0px;right:0px;width:560px;height:3em;font-size: 1.2em !important;z-index:100">
                                                                    <input type="radio" id="telework_option0" name="createEditProfile_telework" value="Never" class="accessAid" checked="checked" onfocus="SliderAPI.selectOptionByValue('createEditProfile_telework', this.value, 'telework')" />
                                                                    <label for="telework_option0" class='option0Label'>Never</label>
                                                                    <input type="radio" id="telework_option1" name="createEditProfile_telework" value="Occasionally" class="accessAid" onfocus="SliderAPI.selectOptionByValue('createEditProfile_telework', this.value, 'telework')"/>
                                                                    <label for="telework_option1" class='option1Label'>Occasionally</label>
                                                                    <input type="radio" id="telework_option2" name="createEditProfile_telework" value="Sometimes" class="accessAid" onfocus="SliderAPI.selectOptionByValue('createEditProfile_telework', this.value, 'telework')"/>
                                                                    <label for="telework_option2" class='option2Label'>Sometimes</label>
                                                                    <input type="radio" id="telework_option3" name="createEditProfile_telework" value="Frequently" class="accessAid" onfocus="SliderAPI.selectOptionByValue('createEditProfile_telework', this.value, 'telework')"/>
                                                                    <label for="telework_option3" class='option3Label'>Frequently</label>
                                                                    <input type="radio" id="telework_option4" name="createEditProfile_telework" value="Most of the time" class="accessAid" onfocus="SliderAPI.selectOptionByValue('createEditProfile_telework', this.value, 'telework')"/>
                                                        ...
                                                        <div style='display:inline-block;width:48%'>
                                                            <div class="multi-btn-group clearfix">
                                                                <div id='createEditProfile_flexHours' style="position:absolute;top:0px;right:0px;width:560px;height:3em;font-size: 1.2em !important;z-index:100">
                                                                    <input type="radio" id="flexHours_option0" name="createEditProfile_flexHours" value="Never" class="accessAid" checked="checked" onfocus="SliderAPI.selectOptionByValue('createEditProfile_flexHours', this.value, 'flexHours')" />
                                                                    <label for="flexHours_option0" class='option0Label'>Never</label>
                                                                    <input type="radio" id="flexHours_option1" name="createEditProfile_flexHours" value="Occasionally" class="accessAid" onfocus="SliderAPI.selectOptionByValue('createEditProfile_flexHours', this.value, 'flexHours')"/>
                                                                    <label for="flexHours_option1" class='option1Label'>Occasionally</label>
                                                                    <input type="radio" id="flexHours_option2" name="createEditProfile_flexHours" value="Sometimes" class="accessAid" onfocus="SliderAPI.selectOptionByValue('createEditProfile_flexHours', this.value, 'flexHours')"/>
                                                                    <label for="flexHours_option2" class='option2Label'>Sometimes</label>
                                                                    <input type="radio" id="flexHours_option3" name="createEditProfile_flexHours" value="Frequently" class="accessAid" onfocus="SliderAPI.selectOptionByValue('createEditProfile_flexHours', this.value, 'flexHours')"/>
                                                                    <label for="flexHours_option3" class='option3Label'>Frequently</label>
                                                                    <input type="radio" id="flexHours_option4" name="createEditProfile_flexHours" value="Most of the time" class="accessAid" onfocus="SliderAPI.selectOptionByValue('createEditProfile_flexHours', this.value, 'flexHours')"/>
