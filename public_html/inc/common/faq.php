<section class="faq hidden" id="faqSection">
	...
	<div class="block-container">
		...
		<div class="flex-grid">
			...
			<div class="faq__content-wrapper box lg-3of4">
				...
				<a id="credentialingReferences" aria-hidden="true"></a>
				...
				<a id="credentialingEvidence" aria-hidden="true"></a>
				...
				<div class="faq__introduction-wrapper" id="faqIntroduction">
					...
					<p>Curabitur quis est et nisi luctus rhoncus. Nulla sed fermentum magna. Suspendisse vehicula venenatis nibh. Nam molestie urna vel aliquet maximus. Pellentesque rhoncus purus a est vulputate, sodales pretium quam pellentesque. Aliquam et accumsan magna, in euismod nisi. Interdum et malesuada fames ac ante ipsum primis in faucibus. Fusce non ullamcorper urna. Sed non iaculis magna.</p>
