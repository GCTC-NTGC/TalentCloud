    ...
    <div class="block-container">
        ...
        <form class="form__wrapper" name="createJobPosterForm" id="createJobPosterForm" method="post" enctype="application/x-www-form-urlencoded">
            ...
            <div id="createJobPosterCreateTab" class="stepGroup">
                ...
                <h3 class="form__title">Job Poster Details</h3>
                ...
                */ ?>
                ...
                <fieldset class="form__fieldset form__form-section" id="createJobPosterDetailsSection">
                ...
                <h3 class="form__title box full">Questions for the Applicant</h3>
