...
<section class="hidden application-preview" id="applicationPreview">
	...
	<div class="content-container">
		...
		<div class="application-preview__button-wrapper">
			<button class="button--grey" onclick="JobApplicationAPI.showCreateJobApplication(document.getElementById('createJobApplicationJobPosterId').value)">Edit Application</button>
