...
<section class="applicant-evidence application-section" data-application-section="asset-criteria">
    ...
    <div class="application-button__wrapper">
        ...
        <button class="button--yellow" value="View" onclick="EvidenceAPI.saveEvidence('asset', function(){JobApplicationPreviewAPI.showJobApplicationPreview(document.getElementById('createJobApplicationJobPosterId').value);})">
            Save and Preview
        </button>
