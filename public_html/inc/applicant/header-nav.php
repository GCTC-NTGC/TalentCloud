<nav id="wb-sm">
    <div class="topbar transparent" id="site--topbar">
        ...
        <div class="row">
            <div class="nav-container">
                <ul class="navbar-right" role="menubar">
                    ...
                    <li class="top-nav--link">
                        <div id="register">
                            <?php //<a href="javascript:void(0)" id="registerLink" onclick="UserAPI.showRegisterForm(this);">Register</a> ?>
            ...
            <?php //<!--div id="logo" class="logo-container"> ?>
            <?php //<a href="/" role="img" aria-label="GC Talent Cloud"> ?>
            <?php //<img class="tc-logo" src="/images/talentcloudHomepage.png" width="259" alt="GC Talent Cloud logo"/> ?>
            <?php //</a> ?>
            <?php //<div class="h1 col-xs-12 col-sm-7 col-md-6">People have a right to meaningful work.</div> ?>
            <?php //</div--> ?>
