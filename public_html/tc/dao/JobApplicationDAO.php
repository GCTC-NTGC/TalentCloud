...
class JobApplicationDAO extends BaseDAO {
    ...
    public static function createJobPosterApplication(JobPosterApplication $jobPosterApplication) {
        ...
        $sqlStr = "INSERT INTO job_poster_application
            (application_job_poster_id, user_id, job_poster_application_status_id, citizenship_declaration_id)
            VALUES
            (:job_poster_id, :user_id, :job_poster_application_status_id, :citizenship_declaration_id)       
        ;";
