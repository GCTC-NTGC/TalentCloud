...
--
-- Table structure for table `citizenship_declaration`
--

DROP TABLE IF EXISTS `citizenship_declaration`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `citizenship_declaration` (
  ...
  UNIQUE KEY `citizenship_declaration_id_UNIQUE` (`citizenship_declaration_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `citizenship_declaration`
--

LOCK TABLES `citizenship_declaration` WRITE;
/*!40000 ALTER TABLE `citizenship_declaration` DISABLE KEYS */;
INSERT INTO `citizenship_declaration` VALUES (1,'Canadian Citizen'),(2,'Permanent Resident of Canada'),(3,'Open - Work Permit'),(4,'Closed - Work Permit'),(5,'I am currently not entitled to work in Canada');
/*!40000 ALTER TABLE `citizenship_declaration` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `citizenship_declaration_details`
--

DROP TABLE IF EXISTS `citizenship_declaration_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `citizenship_declaration_details` (
  ...
  UNIQUE KEY `citizenship_declaration_details_id_UNIQUE` (`citizenship_declaration_details_id`),
  KEY `fk__citizenship_declaration_details__citizenship_declaration` (`citizenship_declaration_id`),
  CONSTRAINT `fk__citizenship_declaration_details__citizenship_declaration` FOREIGN KEY (`citizenship_declaration_id`) REFERENCES `citizenship_declaration` (`citizenship_declaration_id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `citizenship_declaration_details`
--

LOCK TABLES `citizenship_declaration_details` WRITE;
/*!40000 ALTER TABLE `citizenship_declaration_details` DISABLE KEYS */;
INSERT INTO `citizenship_declaration_details` VALUES (1,1,1,'Canadian Citizen'),(2,1,2,'\nCitoyen Canadien'),(3,2,1,'Permanent Resident of Canada'),(4,2,2,'\nRésident Permanent du Canada'),(5,3,1,'Open - Work Permit'),(6,3,2,'Open - Permis de Travail'),(7,4,1,'Closed - Work Permit'),(8,4,2,'Fermé - Permis de Travail'),(9,5,1,'I am currently not entitled to work in Canada'),(10,5,2,'Je n\'ai Actuellement pas le Droit de Travailler au Canada');
/*!40000 ALTER TABLE `citizenship_declaration_details` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `job_application_answer` VALUES (0000000009,0000000003,''),(0000000010,0000000003,''),(0000000011,0000000005,'I\'ve worked on administrative projects before, and I believe my experience in the private sector would translate well to the public service.'),(0000000013,0000000004,''),(0000000013,0000000006,'dtydtry'),(0000000014,0000000004,''),(0000000014,0000000006,'drtydrty');
...
CREATE TABLE `job_poster_application` (
  ...
  `citizenship_declaration_id` int(10) DEFAULT NULL,
  ...
  KEY `fk__job_poster_application__citizenship_declaration_idx` (`citizenship_declaration_id`),
  ...
  CONSTRAINT `fk__job_poster_application__citizenship_declaration` FOREIGN KEY (`citizenship_declaration_id`) REFERENCES `citizenship_declaration` (`citizenship_declaration_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
INSERT INTO `job_poster_application` VALUES (0000000002,0000000004,0000000001,'2018-06-26 16:08:20',NULL,0000000008),(0000000003,0000000004,0000000001,'2018-06-26 16:08:49',NULL,0000000010),(0000000004,0000000007,0000000001,'2018-06-26 16:26:19',NULL,0000000010),(0000000005,0000000006,0000000001,'2018-06-26 16:28:08',NULL,0000000008),(0000000006,0000000007,0000000001,'2018-06-26 16:37:19',NULL,0000000006);
...
INSERT INTO `job_seeker_profile` VALUES (0000000003,NULL,NULL,NULL,NULL,'2018-06-26 15:23:39'),(0000000004,NULL,NULL,NULL,NULL,'2018-06-26 15:28:50'),(0000000005,NULL,NULL,NULL,NULL,'2018-06-26 15:34:51'),(0000000006,NULL,NULL,NULL,NULL,'2018-06-26 15:35:35'),(0000000007,NULL,NULL,NULL,NULL,'2018-06-26 15:36:23'),(0000000008,'','A software engineer with a passion for clean, readable code','','','2018-06-26 15:37:36'),(0000000009,'','A software engineer with a passion for clean, readable code','','','2018-06-26 15:44:17'),(0000000010,NULL,NULL,NULL,NULL,'2018-06-26 15:55:02'),(0000000011,NULL,NULL,NULL,NULL,'2018-06-26 16:03:37'),(0000000012,'','Sample Tagline','@joshdrink','joshdrink','2018-06-26 16:35:42');
...
INSERT INTO `manager_profile_to_team_culture` VALUES (0000000005,0000000004),(0000000006,0000000004),(0000000007,0000000004),(0000000008,0000000004),(0000000009,0000000004),(0000000010,0000000004),(0000000012,0000000004),(0000000013,0000000004),(0000000014,0000000004),(0000000016,0000000005),(0000000017,0000000005);
...
INSERT INTO `manager_profile_to_work_environment` VALUES (0000000005,3),(0000000006,3),(0000000007,3),(0000000008,3),(0000000009,3),(0000000010,3),(0000000011,4),(0000000012,3),(0000000013,3),(0000000014,3),(0000000015,4),(0000000016,4),(0000000017,4);
...
INSERT INTO `user` VALUES (0000000004,'obyrne.gray@gmail.com','Gray O\'Byrne',1,0000000001,517),(0000000005,'Rosita.Kwok@tbs-sct.gc.ca','Rosita Kwok',1,0000000001,1748),(0000000006,'grant.d.barnes@gmail.com','Grant Barnes',1,0000000001,11959),(0000000007,'obyrnegray@gmail.com','Test Account',1,0000000003,8655),(0000000008,'tristan.o.rourke@gmail.com','Morgan O\'Rourke',1,0000000001,15544),(0000000009,'talent.cloud-nuage.de.talents@tbs-sct.gc.ca','Talent Cloud Tester',1,0000000003,8644),(0000000010,'imjoshdrink@gmail.com','Josh Beveridge',1,0000000001,3619);
...
INSERT INTO `user_job_seeker_profiles` VALUES (0000000004,0000000003),(0000000005,0000000004),(0000000006,0000000005),(0000000007,0000000006),(0000000008,0000000007),(0000000008,0000000008),(0000000008,0000000009),(0000000009,0000000010),(0000000010,0000000011),(0000000010,0000000012);
...
INSERT INTO `work_environment` VALUES (0000000003,'option0','option3','option2'),(0000000004,'right','option3','option2');
...
-- Dump completed on 2018-06-26 18:09:49
