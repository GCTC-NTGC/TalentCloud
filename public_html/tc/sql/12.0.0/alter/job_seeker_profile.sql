...
ADD COLUMN `job_seeker_profile_twitter_link` VARCHAR(65) NULL DEFAULT NULL AFTER `job_seeker_profile_tagline`,
ADD COLUMN `job_seeker_profile_linkedin_link` VARCHAR(65) NULL DEFAULT NULL AFTER `job_seeker_profile_twitter_link`,
