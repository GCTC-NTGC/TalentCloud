...
DROP TABLE IF EXISTS `talentcloud`.`job_poster_developing_competency`;
CREATE TABLE `talentcloud`.`job_poster_developing_competency` (
  ...
  `developing_competency` LONGTEXT NOT NULL,
