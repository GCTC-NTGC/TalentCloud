...
(1,'jobPosterSubnavLabel', 'À propos de ce travail :', 2),
(1,'jobPosterSubnavItemBasics','Basic Information', 1),
(1,'jobPosterSubnavItemBasics', 'Informations de base', 2),
(1,'jobPosterSubnavItemImpact','Impact', 1),
(1,'jobPosterSubnavItemImpact', 'Impact', 2),
(1,'jobPosterSubnavItemWork','Your Work', 1),
(1,'jobPosterSubnavItemWork', 'Votre travail', 2),
...
(1,'jobPosterSubnavItemKnow','Need to Know', 1),
(1,'jobPosterSubnavItemKnow', 'Dois savoir', 2),
(1,'jobPosterSubnavItemApply','Apply for this Job', 1),
(1,'jobPosterSubnavItemApply', 'Postuler pour ce poste', 2),
(1,'jobPosterContentTitleBasics','Basic Information', 1),
(1,'jobPosterContentTitleBasics', 'Informations de base', 2),
(1,'jobPosterContentTitleImpact','Impact', 1),
(1,'jobPosterContentTitleImpact', 'Impact', 2),
(1,'jobPosterContentTitleWork','Your Work', 1),
(1,'jobPosterContentTitleWork', 'Votre travail', 2),
...
(1,'jobPosterContentTitleKnow','Need to Know', 1),
(1,'jobPosterContentTitleKnow', 'Dois savoir', 2),
(1,'jobPosterContentTitleApply','Apply for this Job', 1),
(1,'jobPosterContentTitleApply', 'Postuler pour ce poste', 2),
(1,'jobPosterCoreCompetenciesLabel','Need to Have', 1),
(1,'jobPosterCoreCompetenciesLabel', 'Besoin d\'avoir', 2),
(1,'jobPosterDevelopingCompetenciesLabel','Nice to Have', 1),
(1,'jobPosterDevelopingCompetenciesLabel', 'Agréable d\'avoir', 2)
;
