...
UPDATE `talentcloud`.`base_content` SET `base_content_value`='I <strong>rarely</strong> review my team\'s work before it is shared' WHERE `base_content_key`='managerProfile_review_option1' AND base_content_locale_id=1;
UPDATE `talentcloud`.`base_content` SET `base_content_value`='Je revois <strong>rarement</strong> le travail de mon équipe avant qu\'elle ne soit partagée.' WHERE `base_content_key`='managerProfile_review_option1' AND base_content_locale_id=2;
UPDATE `talentcloud`.`base_content` SET `base_content_value`='I <strong>sometimes</strong> review my team\'s work before it is shared.' WHERE `base_content_key`='managerProfile_review_option2' AND base_content_locale_id=1;
UPDATE `talentcloud`.`base_content` SET `base_content_value`='Je révise <strong>parfois</strong> le travail de mon équipe avant de le partager.' WHERE `base_content_key`='managerProfile_review_option2' AND base_content_locale_id=2;
UPDATE `talentcloud`.`base_content` SET `base_content_value`='I <strong>usually</strong> review my team\'s work before it is shared.' WHERE `base_content_key`='managerProfile_review_option3' AND base_content_locale_id=1;
UPDATE `talentcloud`.`base_content` SET `base_content_value`='J\'examine <strong>habituellement</strong> le travail de mon équipe avant de le partager' WHERE `base_content_key`='managerProfile_review_option3' AND base_content_locale_id=2;
UPDATE `talentcloud`.`base_content` SET `base_content_value`='I <strong>almost always</strong> review my team\'s work before it is shared.' WHERE `base_content_key`='managerProfile_review_option4' AND base_content_locale_id=1;
UPDATE `talentcloud`.`base_content` SET `base_content_value`='Je revois <strong>presque toujours</strong> le travail de mon équipe avant de le partager.' WHERE `base_content_id`='managerProfile_review_option4' AND base_content_locale_id=2;
UPDATE `talentcloud`.`base_content` SET `base_content_value`='I <strong>almost never</strong> get in early or stay late to get some extra work done.' WHERE `base_content_id`='managerProfile_stayLate_option0' AND base_content_locale_id=1;
