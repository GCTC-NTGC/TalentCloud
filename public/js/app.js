...
(function ($) {
  ...
  var $root = $("html, body"); // Document Locale

  var docLocale = document.documentElement.lang; // Add has attribute Function
  ...
  $(document).ready(function () {
    ...
    function hiwTrigger(trigger) {
      var hiwID = $(trigger).attr("data-tc-hiw-id");
      ...
      if (window.matchMedia("screen and (min-width: 48em)").matches) {// Nothing
      } else {
    ...
    $("section.application__view-layout.submitted").on("click", "button[data-button-type='expand-all']", function () {
    ...
    function requiredFields() {
      ...
      $("select:required").each(function (e) {
        ...
        var label = $(this).parent().siblings("label:not(:has(.fa-asterisk))");
        label.append("<span class='form__required'><i class='fa fa-asterisk' aria-label='Asterisk'></i></span>");
      });
      $(".form__radio-group").each(function (e) {
        $(this).addClass("required"); // Find labels that haven't had the asterisk added yet

        $(this).children(":not(:has(.fa-asterisk))").find(".form__label").append("<span class='form__required'><i class='fa fa-asterisk' aria-label='Asterisk'></i></span>");
      }); // Required field for checkbox input

      $("input[type='checkbox']:required").each(function (e) {
        $(this).parent().addClass("required");
        var label = $(this).parent(":not(:has(.fa-asterisk))");
        label.append("<span class='form__required'><i class='fa fa-asterisk' aria-label='Asterisk'></i></span>");
      });
    }
    ...
    function labelHandlers() {
      ...
      $("#language_requirement_confirmed").change(function (e) {
        var checkbox = $(this);
        var content = checkbox.next('.checkbox__wrapper').find('.checkbox__content > i');
        ...
        if (checkbox.parent().siblings(".error-message").hasClass("hidden")) {
          checkbox.parent().siblings(".error-message").removeClass("hidden");
        } else {
          checkbox.parent().siblings(".error-message").addClass("hidden");
        }
      });
    }
...
module.exports = __webpack_require__(/*! /Users/Grant/Sites/tc-docker/TalentCloud/resources/assets/js/app.js */"./resources/assets/js/app.js");
