...
(11,6,'en','Types of teams I work well on...','Where do you find yourself working at your best? Are you the type of individual who thrives in large-scale, fast paced environments? Maybe you prefer to work with a smaller, close-knit team with a high trust relationship? Perhaps still you find yourself at your best when working from home or another remote location? Help a potential hiring manager better understand you, your needs, and your strengths so that you may find exactly what you are looking for. ',current_timestamp,current_timestamp),
(12,6,'fr','Les types d’équipe dans lesquels je travaille bien ','Où vous trouvez-vous travailler à votre meilleur? Êtes-vous le type d'individu qui prospère dans des environnements à grande échelle et au rythme rapide? Peut-être préférez-vous travailler avec une équipe plus petite et soudée avec une relation de confiance élevée? Peut-être vous trouvez-vous toujours à votre meilleur lorsque vous travaillez à domicile ou dans un autre lieu éloigné? Aidez un responsable du recrutement potentiel à mieux vous comprendre, à comprendre vos besoins et vos forces, afin que vous puissiez trouver exactement ce que vous recherchez.',current_timestamp,current_timestamp);
