...
(12,6,'fr','Les types d’équipe dans lesquels je travaille bien ','Travaillez-vous le mieux lorsque vous collaborez à des projets ou lorsque vous avez un rôle où vous pouvez faire votre propre travail? Préfères-tu avoir une routine ou prospères-tu dans des équipes où chaque jour est différent? Êtes-vous hautement adaptable à différents styles de travail ou avez-vous une préférence pour des méthodes de travail particulières? Voici votre chance d’informer les responsables sur le type d’équipe (s) sur laquelle vous travaillez bien et sur le (s) rôle (s) que vous préférez jouer.',current_timestamp,current_timestamp);
