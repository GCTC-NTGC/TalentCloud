...
class ApplicationController extends Controller
{
    ...
    /**
     * Show the form for editing Application basics.
     *
     * @param  \App\Models\JobApplication  $jobApplication
     * @return \Illuminate\Http\Response
     */
    public function edit_basics(JobApplication $jobApplication)
    {
            ...
            "application" => [
                ...
                "tracker" => [
                    "00" => [
                        ...
                        "status" => "error",
                        "url" => route('job.application.edit.1', $jobApplication->job_poster->id)
                    ],
                    "01" => [
                        "step" => "2",
                        "title" => "My Experience",
                        "status" => "complete",
                        "url" => route('job.application.edit.2', $jobApplication->job_poster->id)
                    ],
                    "02" => [
                        "step" => "3",
                    ...
                    "03" => [
                        ...
                        "status" => "incomplete",
                        "url" => route('job.application.edit.4', $jobApplication->job_poster->id)
                    ],
                    "04" => [
                        "step" => "5",
                        "title" => "Review my Application",
                        "status" => "incomplete",
                        "url" => route('job.application.edit.5', $jobApplication->job_poster->id)
                    ]
                ],
                "modals" => [
                    "00" => [
    ...
    /**
     * Show the form for editing Application Experience.
     *
     * @param  \App\Models\JobApplication  $jobApplication
     * @return \Illuminate\Http\Response
     */
    public function edit_experience(JobApplication $jobApplication)
    {
        //
    }

    /**
     * Show the form for editing Application Essential Skills.
     *
     * @param  \App\Models\JobApplication  $jobApplication
     * @return \Illuminate\Http\Response
     */
    public function edit_essential_skills(JobApplication $jobApplication)
    {
        //
    }

    /**
     * Show the form for editing Application Asset Skills.
     *
     * @param  \App\Models\JobApplication  $jobApplication
     * @return \Illuminate\Http\Response
     */
    public function edit_asset_skills(JobApplication $jobApplication)
    {
        //
    }

    /**
     * Update the Application Basics in storage.
     *
     * @param  \App\Models\JobApplication  $jobApplication
     * @return \Illuminate\Http\Response
     */
    public function update_basics(JobApplication $jobApplication)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update_experience(JobApplication $jobApplication)
    {
        //
    }

    /**
     * Update the Application Essential Skills in storage.
     *
     * @param  \App\Models\JobApplication  $jobApplication
     * @return \Illuminate\Http\Response
     */
    public function update_essential_skills(JobApplication $jobApplication)
    {
        //
    }

    /**
     * Update the Application Asset Skills in storage.
     *
     * @param  \App\Models\JobApplication  $jobApplication
     * @return \Illuminate\Http\Response
     */
    public function update_asset_skills(JobApplication $jobApplication)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function submit(JobApplication $jobApplication)
    {
        //
    }
}
