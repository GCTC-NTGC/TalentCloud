 ...
 * Generated for Laravel 6.6.0 on 2019-12-03 20:59:48.
 *
...
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Criteria[]|Criteria create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Criteria[]|Criteria make($attributes = [])
    */
    class CriteriaFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|SkillDeclaration[]|SkillDeclaration create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|SkillDeclaration[]|SkillDeclaration make($attributes = [])
    */
    class SkillDeclarationFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|RatingGuideAnswer[]|RatingGuideAnswer create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|RatingGuideAnswer[]|RatingGuideAnswer make($attributes = [])
    */
    class RatingGuideAnswerFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|JobPosterKeyTask[]|JobPosterKeyTask create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|JobPosterKeyTask[]|JobPosterKeyTask make($attributes = [])
    */
    class JobPosterKeyTaskFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Assessment[]|Assessment create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Assessment[]|Assessment make($attributes = [])
    */
    class AssessmentFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|JobPoster[]|JobPoster create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|JobPoster[]|JobPoster make($attributes = [])
    */
    class JobPosterFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|JobPosterQuestion[]|JobPosterQuestion create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|JobPosterQuestion[]|JobPosterQuestion make($attributes = [])
    */
    class JobPosterQuestionFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|RatingGuideQuestion[]|RatingGuideQuestion create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|RatingGuideQuestion[]|RatingGuideQuestion make($attributes = [])
    */
    class RatingGuideQuestionFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|WorkEnvironment[]|WorkEnvironment create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|WorkEnvironment[]|WorkEnvironment make($attributes = [])
    */
    class WorkEnvironmentFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
...
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Applicant[]|Applicant create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Applicant[]|Applicant make($attributes = [])
    */
    class ApplicantFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Manager[]|Manager create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Manager[]|Manager make($attributes = [])
    */
    class ManagerFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|JobApplication[]|JobApplication create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|JobApplication[]|JobApplication make($attributes = [])
    */
    class JobApplicationFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|JobApplicationAnswer[]|JobApplicationAnswer create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|JobApplicationAnswer[]|JobApplicationAnswer make($attributes = [])
    */
    class JobApplicationAnswerFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App\Models {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|TeamCulture[]|TeamCulture create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|TeamCulture[]|TeamCulture make($attributes = [])
    */
    class TeamCultureFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
